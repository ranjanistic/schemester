...
let initializeElements=_=>{
    ...
    manage.logout.addEventListener(click,_=>{
        showLoader();
        logoutUser(false)
    },false);
    ...
    users.invite.addEventListener(click,_=>{
        ...
        dialog.onButtonClick(0,_=>{dialog.existence(false);});
