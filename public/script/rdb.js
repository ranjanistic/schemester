          ...
          switch (lcursor.value.localuiid) {
            case kpath.localUIID:{
              ...
              if (lcursor.value.uiid != null) {
                ...
                openAdminDatabase(lcursor.value.uiid,_=>{action()}); //open database of given stored institituion uiid name.
              } else {
                clog('L uiid null ');
                ...
                lerequest.onsuccess = _=>{
                  clog("success added :" + data+",opening db" + lcursor.value.uiid);
                  openAdminDatabase(lcursor.value.uiid,_=>{action()});
                };
                lerequest.onerror = _=>{
